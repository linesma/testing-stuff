...
os.chmod ('/etc/xdg/autostart/manjaroptimus-appindicator.desktop', 0o755, '/usr/bin/manjaroptimus-appindicator', 0o755, '/usr/share/manjaroptimus-appindicator/scripts/scripts/pkexec_nvidia.sh', 0o755, '/usr/share/manjaroptimus-appindicator/scripts/scripts/pkexec_intel.sh', 0o755)
